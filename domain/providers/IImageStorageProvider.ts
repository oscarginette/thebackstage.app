 ...
 *
 * Interface for image storage providers (Cloudinary, Vercel Blob, S3, etc.)
 *
 * Clean Architecture: Domain layer interface.
 * SOLID Compliance:
 * - Dependency Inversion Principle (DIP): Domain depends on abstraction, not implementation
 * - Interface Segregation Principle (ISP): Small, focused interface with only needed methods
 * - Open/Closed Principle (OCP): Easy to add new storage providers without modifying domain
 */
